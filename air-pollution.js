...
For example, a threshold of 0.4 means that there must be less than 40% of total samples classified
...
const checkAir = function (samples, threshold) {
  let dirty = 0
  let clean = 0
  //loop through samples and increment dirty for each instance it finds, or clean otherwise
  ...
  //calculate proportion of samples that are dirty, compare with threshold, return answer
  let proportionDirty = dirty/(clean + dirty)
